/**
 * VirtualJoystick - Touch/mouse joystick for mobile controls
...
var VirtualJoystick = function(opts) {
  ...
  if (this._mouseSupport) {
    ...
    this._container.addEventListener('mousedown', this._$onMouseDown, { passive: false });
    this._container.addEventListener('mouseup', this._$onMouseUp, { passive: false });
    this._container.addEventListener('mousemove', this._$onMouseMove, { passive: false });
  }
}
