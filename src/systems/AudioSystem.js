...
class AudioSystem {
    ...
    setupUserInteractionTracking() {
        ...
        document.addEventListener('touchstart', markInteraction, { once: false });
    }
    ...
    retryTickTock() {
        if (this.tickTockAudio && this.backgroundMusicStarted && this.userInteracted) {
            this.tickTockAudio.currentTime = 0;
    ...
    retryBuzzAmbience() {
        if (this.buzzAmbience && this.backgroundMusicStarted && this.userInteracted) {
            this.buzzAmbience.currentTime = 0;
